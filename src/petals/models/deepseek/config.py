...
class DistributedDeepSeekConfig(Qwen2Config, ClientConfig, PTuneConfig, LMHeadConfig):
    block_class = WrappedDeepSeekBlock
    ...
    def from_pretrained(
        ...
        logger.info("Loading DeepSeek model configuration.")
