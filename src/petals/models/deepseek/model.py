...
class DistributedDeepSeekModel(FromPretrainedMixin, PTuneMixin, Qwen2Model):
    """DeepSeekModel, but all transformer layers are hosted by the swarm"""
    ...
    def __init__(self, config: DistributedDeepSeekConfig, *, dht: Optional[hivemind.DHT] = None):
...
class DistributedDeepSeekForCausalLM(FromPretrainedMixin, RemoteGenerationMixin, Qwen2ForCausalLM):
...
class DistributedDeepSeekForSequenceClassification(FromPretrainedMixin, Qwen2ForSequenceClassification):
    _keys_to_ignore_on_load_missing = DistributedDeepSeekModel._keys_to_ignore_on_load_missing
    _keys_to_ignore_on_load_unexpected = DistributedDeepSeekModel._keys_to_ignore_on_load_unexpected
